...
export default function Footer() {
    return (
        <footer className="w-full bg-[linear-gradient(287deg,var(--red-secondary)_50%,var(--red-primary)_50%)]">
            <div className="mx-auto max-w-7-xl">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0 py-5 px-5">
                        <a href="http://localhost:3000/" className="flex items-center">
                            ...
                            />
                            <span className="self-center text-2xl text-(--branco) font-semibold whitespace-nowrap">GreatestStore</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 py-5 px-5">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-(--branco) uppercase">Recursos</h2>
                            <ul className="text-(--branco)">
                                <li className="mb-4">
                                    <a href="https://flowbite.com" className="hover:underline">GreatestStore</a>
                                </li>
                                <li>
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-(--branco) uppercase">Siga-nos</h2>
                            <ul className="text-(--branco)">
                                <li className="mb-4">
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-(--branco) uppercase">Legal</h2>
                            <ul className="text-(--branco)">
                                <li className="mb-4">
                ...
                <span className="text-sm text-(--branco) sm:text-center">© 2022 <a href="https://localhost/3000" className="hover:underline">GreatestStore</a>. All Rights Reserved.
                </span>
                <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    <a href="#" className="text-(--branco) hover:text-(--branco)">
